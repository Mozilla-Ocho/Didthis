  ...
  return (
    <PagePad semiWide>
      ...
      <div className="prose text-md text-bodytext">
        ...
        <p>We care about your privacy. The <a href="https://www.mozilla.org/privacy/">Mozilla Privacy Policy</a> describes how we handle any information that we collect about you.  This Privacy Notice provides more information about what data Didthis collects and shares, and why.</p>
        ...
        <p><strong>Post Information</strong>. We maintain data about your activity on Didthis, including the content that you post to Didthis, your platform interactions, and any other information that you share publicly. The content you post on your Didthis webpage will, by default, be private and accessible only by you. If you choose to make your Didthis webpage publicly available by switching your Didthis webpage from “private” to “public”, the URL of your Didthis webpage will be publicly visible and can be accessible by other Didthis users or anyone else who visits your Didthis webpage.</p>
        <p>When you post content on your Didthis webpage, we store information about the date and time the post was created, and the device that it was posted from.</p>
        <p><strong>Interaction data</strong>. Mozilla receives data about your interactions with Didthis, including when you log in and out, and the preferences you set. In addition to the information that you provide, such as the content you post to your Didthis webpage, we also receive information about your activity on Didthis, including your clicks and impressions. We may collect this interaction data through third parties, such as Amplitude and Google Analytics.</p>
        <p>We use the information that we collect for several purposes, including to:</p>
        <ul>
          <li>Provide the Didthis service;</li>
          <li>Learn how you and others are using Didthis to make improvements;</li>
        ...
        <p><strong>Location information</strong>. Didthis receives your IP address when you sign up for and use the service. The latest IP address that you used is stored for up to 90 days.  We may also retain server logs that store the IP address of every request made to our server.</p>
        <p>Except as indicated above, Didthis does not share any of your personal data with third parties. However, such data may become accessible to third parties when you publish it online.</p>
      </div>
    </PagePad>
  )
}
