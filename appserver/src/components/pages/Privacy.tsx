  ...
  return (
    <PagePad>
      <div className="flex flex-col gap-2 text-md text-bodytext">
        <H.H4>Privacy Notice</H.H4>
        <H.H3>At Mozilla, we design products with your privacy in mind.</H.H3>
        ...
        <H.H3>Things you should know:</H.H3>
        <H.H4>Information we collect</H.H4>
